import 'package:absensi_apps/Company%20Super%20Admin/edit_salary_page.dart';
...
class SalaryPage extends StatefulWidget {
  ...
  const SalaryPage({super.key, required this.userId, required this.displayName});
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Icon(Icons.account_balance_wallet, size: 50, color: Colors.teal.shade700),
                        ],
                      ),
                      ...
                      monthYearPicker(),
                      const SizedBox(height: 20),
                      _buildSalarySection('Gaji Pokok', gajiPokok, Icons.monetization_on),
                      _buildSalarySection('Tunjangan Harian', totalGajiHarian, Icons.calendar_today, presentDays: presentDays),
                      _buildSalarySection('Potongan Tidak Masuk', potonganAbsent, Icons.do_not_disturb_on, absentDays: absentDays),
                      _buildSalarySection('Potongan Terlambat', totalPotonganTelat, Icons.timer_off, lateDays: lateDays),
                      _buildSalarySection('Potongan Cuti', potonganCuti, Icons.event_busy, leaveDays: leaveDays),
                      const Divider(height: 30, thickness: 2, color: Colors.grey),
                      _buildSalarySection('Total Gaji', totalGaji, Icons.savings, highlight: true),
                      TextButton(
                        onPressed: () {
                          Navigator.push(
                            context,
  ...
  Widget _buildSalarySection(String label, num value, IconData icon,
    ...
    return Card(
      ...
      child: ListTile(
        ...
        leading: Icon(icon, color: highlight ? Colors.orange : Colors.teal.shade700, size: 28),
        title: Text(
          label,
          style: TextStyle(
