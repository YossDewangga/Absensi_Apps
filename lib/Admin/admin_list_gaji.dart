import 'package:absensi_apps/Admin/salary.dart';
import 'package:flutter/material.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:intl/intl.dart';

class AdminListGaji extends StatefulWidget {
  const AdminListGaji({super.key});

  @override
  _AdminListGajiState createState() => _AdminListGajiState();
}

class _AdminListGajiState extends State<AdminListGaji> {
        ...
        itemBuilder: (context, index) {
          ...
          return Card(
            ...
            child: ListTile(
              ...
              onTap: () => _navigateToSalaryPage (employee.id, displayName),
            ),
          );
        },
      ),
  ...
  void _navigateToSalaryPage (String userId, String displayName) {
    Navigator.push(
      context,
      MaterialPageRoute(
...
class _AddHolidayPageState extends State<AddHolidayPage> {
  ...
  final TextEditingController _descriptionController = TextEditingController(); // Deklarasi controller
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: TextField(
                  controller: _descriptionController, // Gunakan controller yang didefinisikan
